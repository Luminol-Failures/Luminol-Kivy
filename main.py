...
class EditorLayout(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.topbuttons[4].bind(state=self.event_graphics)
        self.topbuttons[5].bind(state=self.event_boxes)
    ...
    def event_graphics(self, instance, *args):
        self.tilemap.set_event_graphic(instance.state)
    
    def event_boxes(self, instance, *args):
        self.tilemap.set_boxes(instance.state)
